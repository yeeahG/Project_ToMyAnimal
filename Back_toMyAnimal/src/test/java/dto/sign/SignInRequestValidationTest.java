...
class SignInRequestValidationTest {
    ...
    private SignInRequest createRequest() {
        return new SignInRequest("id1", "123456a!");
    }

    private SignInRequest createRequestWithEmail(String identifier) {
        return new SignInRequest(identifier, "123456a!");
    }

    private SignInRequest createRequestWithPassword(String password) {
        return new SignInRequest("id1", password);
    }
}