...
public class BoardCreateRequestFactory {
    public static BoardCreateRequest createBoardCreateRequest() {
        return new BoardCreateRequest("title", "content", 0, 1L, 1L, List.of(
    ...
    public static BoardCreateRequest createBoardCreateRequest(String title, String content, Integer type, Long memberId, Long categoryId, List<MultipartFile> images) {
    ...
    public static BoardCreateRequest createBoardCreateRequestWithType(Integer type) {
    ...
    public static BoardCreateRequest createBoardCreateRequestWithMemberId(Long memberId) {
        return new BoardCreateRequest("title", "content", 0, memberId, 1L, List.of());
    }

    public static BoardCreateRequest createBoardCreateRequestWithCategoryId(Long categoryId) {
        return new BoardCreateRequest("title", "content", 0, 1L, categoryId, List.of());
    }

    public static BoardCreateRequest createBoardCreateRequestWithImages(List<MultipartFile> images) {
        return new BoardCreateRequest("title", "content", 0, 1L, 1L, images);
    }
